...
const AVATAR_ITEMS = [
  {
    id: "avatar-agents",
    label: "Avatar Agents",
    src: "/media/avatar-agents.gif",
    position: "center 16%"
  },
  {
    id: "enterprise-ai",
    label: "Enterprise AI",
    src: "/media/enterprise-ai.gif",
    position: "center 18%"
  },
  {
    id: "research",
    label: "Research",
    src: "/media/research.gif",
    position: "center 15%"
  },
  {
    id: "ventures",
    label: "Ventures",
    src: "/media/ventures.gif",
    position: "center 14%"
  }
];
    ...
    <>
      ...
      <div className="menu-overlay" data-menu>
        <nav className="menu-overlay__nav">
          <a href="#ventures" data-menu-link>
            Ventures
          </a>
          <a href="#research" data-menu-link>
            Research
          </a>
      ...
      <main id="top">
        <section className="hero" id="hero" data-hero>
          ...
          <div className="hero__meta hero__meta--right" aria-hidden="true">
            &copy;2024
          </div>
        ...
        <section className="stats-strip" data-stats>
          <div className="stats-strip__item">
            <div className="stats-strip__number" data-count="3">
              0
            </div>
            <div className="stats-strip__label">Languages spoken by our agents</div>
          </div>
          <div className="stats-strip__item">
            <div className="stats-strip__number" data-count="4" data-suffix="B+">
              0
            </div>
            <div className="stats-strip__label">Underserved consumers we study</div>
          </div>
          <div className="stats-strip__item">
            <div className="stats-strip__number" data-count="2">
              0
            </div>
            <div className="stats-strip__label">Active research tracks</div>
          </div>
          <div className="stats-strip__item">
            <div className="stats-strip__number" data-count="2024">
              0
            </div>
            <div className="stats-strip__label">Founded in Singapore</div>
          </div>
        </section>
          ...
          <div className="building__grid">
            <article className="feature-card reveal-up">
              <div className="feature-card__copy">
                ...
                <p>
                  The best AI tools were made for developers. Enterprises got the
                  leftovers. We&apos;re building the operating layer that was supposed to
                  exist.
                </p>
              </div>
            ...
            <article className="feature-card reveal-up">
              <div className="feature-card__copy">
                ...
                <p>
                  Our agents have faces. They speak Hindi, Malay, English and they
                  remember what you said last time.
                </p>
              </div>
              <div className="avatar-grid" aria-label="EVAA agent previews">
                {AVATAR_ITEMS.map((avatar) => (
                  <div className="avatar-orb" key={avatar.id}>
                    <img
                      className="avatar-orb__image"
                      src={avatar.src}
                      alt={avatar.label}
        ...
        <section className="research" id="research">
          ...
          <div className="research__grid">
            <article className="research-card reveal-up">
              ...
              <p>
                Digital commerce assumes a buyer who reads product pages and compares
                prices. Most of the world buys through relationships.
              </p>
              <a href="/research/consumer-behaviour">Read the research -&gt;</a>
            </article>
            <article className="research-card reveal-up">
              <p className="research-card__tag">HEALTH AI</p>
              <h3>Can an AI agent change how someone manages their health?</h3>
              <p>
                Information alone doesn&apos;t change behaviour. Trust does. We&apos;re
                studying whether voice-based AI can close that gap.
              </p>
              <a href="/research/health-ai">Read the research -&gt;</a>
            </article>
          </div>
        </section>
      </main>
        ...
        <div className="footer__col footer__col--right">
          <a className="footer__linkedin" href="#" aria-label="LinkedIn">
            <svg viewBox="0 0 24 24" role="img" aria-hidden="true">
              <path
                d="M6.94 8.5H3.56V20h3.38V8.5Zm.22-3.56A1.94 1.94 0 0 0 5.23 3a1.95 1.95 0 1 0 0 3.89 1.94 1.94 0 0 0 1.93-1.95ZM20 12.88c0-3.46-1.84-5.07-4.3-5.07a3.72 3.72 0 0 0-3.37 1.85V8.5H8.95c.04.77 0 11.5 0 11.5h3.38v-6.42c0-.34.02-.68.13-.92.27-.68.9-1.38 1.96-1.38 1.38 0 1.93 1.04 1.93 2.57V20h3.37v-7.12Z"
                fill="currentColor"
              />
            </svg>
          </a>
      ...
      <button
        ...
        suppressHydrationWarning
      >
        <span className="chat-trigger__label">Talk now</span>
      ...
      <aside className="chatbot-modal" data-chatbot aria-hidden="true">
        ...
        <div className="chatbot-modal__transcript" data-chat-transcript>
          <div className="chatbot-message chatbot-message--ai">
            Hi! I&apos;m EVAA&apos;s AI assistant. What would you like to know?
          </div>
        </div>
